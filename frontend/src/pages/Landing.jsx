...
const s = {
    ...
    statsBar: { display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', borderTop: '0.5px solid #1e2535', borderBottom: '0.5px solid #1e2535' },
    ...
    roleGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16, maxWidth: 900, margin: '0 auto' },
    ...
    stepsRow: { display: 'flex', alignItems: 'flex-start', justifyContent: 'center', gap: 0, marginTop: 40, flexWrap: 'wrap' },
    ...
    footerTop: { background: '#0c0f1a', borderTop: '0.5px solid #1e2535', padding: '40px 32px', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 32 },
...
socialLink: { fontSize: 13, color: '#5a6480', textDecoration: 'none', cursor: 'pointer' },
