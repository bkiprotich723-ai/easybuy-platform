...
const s = {
    ...
    productGrid: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10, maxWidth: 900, margin: '0 auto', textAlign: 'left' },
    ...
    productImgPlaceholder: { width: '100%', height: 120, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 40, background: '#1a1f2e' },
