...
badge2: { background: '#f97066', color: '#fff', fontSize: 11, fontWeight: 600, padding: '2px 7px', borderRadius: 20, minWidth: 20, textAlign: 'center' },
    ...
    statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 12 },
    ...
    tableRow: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', padding: '12px 16px', borderTop: '0.5px solid #1e2535', alignItems: 'center' },
